#!/usr/bin/env python3
"""lightcode - minimal coding assistant with Qwen wrapper API"""
...
LOG_FILE = os.environ.get("NANOCODE_LOG_FILE", os.path.join(os.path.dirname(__file__), "lightcode.log") if LOG else None)
...
def main():
    print(f"{BOLD}lightcode{RESET} | {DIM}{MODEL} (Qwen wrapper){RESET} | {os.getcwd()}{RESET}\n")
